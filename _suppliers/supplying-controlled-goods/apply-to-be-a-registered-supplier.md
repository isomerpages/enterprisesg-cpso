...
To register as a Registered Supplier, ensure your Corppass access to our Consumer Product Safety and Accuracy+ system has been setup (the e-service name is CPSAPLUS). Registration will be immediate if UEN and Corppass are valid. Thereafter, go to {:target="_blank"} and click "Log in via Corppass".
