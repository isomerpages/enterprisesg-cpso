...
|![tip6](/images/product-safety-tips/toughened-glass/tg-tip6-1.png)|Prevent the glass surface of the gas hob from overheating.<br> - Do not cover the glass top (e.g. with aluminium foil as this will prevent heat from dissipating.<br> - Do not leave the wok stand around the gas burnger as heat trapped by wok stand will be deflected to glass top. <img src="/images/product-safety-tips/toughened-glass/tg-tip6-2.png" alt="tip6-2" align="left" style="width:129.5px;height:117px;"><br> - Avoid using oversized cooking utensils (e.g. pans or woks). Heat will be deflected to the glass top from the pan bottom. Refer to the user manual to determine the size of utensils that can be used. <img src="/images/product-safety-tips/toughened-glass/tg-tip6-3.png" alt="tip6-3" align="left" style="width:169.5px;height:123px;"><br>|
